...
class EnhancedUTRP:
    ...
    def generate_initial_solutions(self, k: int = 5, num_solutions: int = 10, l: int = 10, verbose: bool = True) -> List[List[List[int]]]:
        """
    ...
    def dbmosa(self, max_iterations: int = 1000, initial_temp: float = 1.0, 
               cooling_rate: float = 0.95, verbose: bool = True) -> Tuple[List[List[int]], float, float]:
        """Dominance-based Multi-Objective Simulated Annealing"""
        initial_solutions = self.generate_initial_solutions(num_solutions=1, verbose=verbose)
    ...
    def nsga_ii(self, population_size: int = 50, generations: int = 100, 
                crossover_prob: float = 0.8, mutation_prob: float = 0.9, verbose: bool = True) -> List[Tuple[List[List[int]], float, float]]:
        """Non-dominated Sorting Genetic Algorithm EnhancedUTRP"""
        population = self.generate_initial_solutions(num_solutions=population_size, verbose=verbose)
